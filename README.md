...
#### This script will configure a Debian 13 system (during install) to use BTRFS subvolumes and support root snashots
...
- by Don Williams https://github.com/dwilliam62/debian-btrfs-boot
---
...
- Guardrails: environment checks for Debian installer context, root, device
...
```bash
wget -qO debian-btrfs-boot.sh https://github.com/Orgel/debian-btrfs-boot/raw/main/debian-btrfs-boot.sh
...
```bash
wget -qO debian-btrfs-boot.sh https://raw.githubusercontent.com/Orgel/debian-btrfs-boot/main/debian-btrfs-boot.sh
chmod +x ./debian-btrfs-boot.sh
# Preview without making changes
./debian-btrfs-boot.sh --dry-run
```
...
- Repo view:
  https://github.com/Orgel/debian-btrfs-boot/blob/main/debian-btrfs-boot.sh
- Raw file (backup):
  https://raw.githubusercontent.com/Orgel/debian-btrfs-boot/main/debian-btrfs-boot.sh
